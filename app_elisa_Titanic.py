...
#opening the image
image1 = Image.open('img/mapa.jpg')
image2 = Image.open('img/joseph-bruce-owner.jpg')
image3 = Image.open('img/capitan_.jpg')
image4 = Image.open('img/Millvina1.jpg')
image5 = Image.open('img/millvina_news.jpg')
image6 = Image.open('img/Cave_list.jpg')

# gif from local file
#Gif Info
file_ = open('img/jackyrose.gif', "rb")
contents = file_.read()
data_url1 = base64.b64encode(contents).decode("utf-8")
file_.close()

#Gif conclusiones
file_2 = open('img/titanic-band.gif', "rb")
...
dfex1 = pd.read_excel('data/fare_titanic.xlsx',sheet_name='1912')
dfex2 = pd.read_excel('data/fare_titanic.xlsx',sheet_name='Actualidad')
